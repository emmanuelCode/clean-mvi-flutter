...
import 'package:flutter_clean_architecture_with_mvi/features/game_details/presentation/mvi_view/game_details_view_event.dart';
...
class GameDetailsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final action = ref.read(gameDetailsIntentFactoryProvider(id).notifier);
    return game.when(
      data: (data) => RefreshIndicator(
        onRefresh: () async => action.toIntent(LoadGameDetails(gameId: id)),
        child: GameScreen(gameDetailsEntity: data),
      ),
